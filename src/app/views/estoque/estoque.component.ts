...
export class EstoqueComponent {
  ...
  getProducts() {
    this.produtos = [
      ...
      { id: 2, name: 'Produto 2', status: true, manufacturer: 'Formula', category: 'Cachorro', date: '05/03/2024', quantity: 32, code: 'BR766YZJ', minimumLevel: 0, maximumLevel: 100 },
      { id: 3, name: 'Produto 3', status: false, manufacturer: 'Royal Canin', category: 'Aves', date: '12/12/2023', quantity: 3, code: 'BR109LKO', minimumLevel: 0, maximumLevel: 100 },
